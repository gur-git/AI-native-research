...
This document draws on a literature the inquiry is just beginning to read. Sources are cited in [`evidence/reading-list.md`](../evidence/reading-list.md). The synthesis here is a working position, expected to be refined as more is read and as observation accumulates.
