...
A pilot research project, when the domain is chosen, will live in [`case-studies/`](case-studies/) and act as a sustained test of the methodology on a real research problem. Until then, the inquiry develops on the maintainer's own working sessions and on conversations with other researchers.

## Status

GOAL v1, 2026-05-17. Foundation v1 has been in place since 2026-05-06 — five documents covering the central argument, the AI-attributes catalog, the implications gesture, and the open questions. The methodology has 15 initial guidelines at status `proposed`. Evidence collection beyond the initial reading list has begun with the staged literature survey under [`evidence/survey-2026-05/`](evidence/survey-2026-05/). The pilot research domain has not yet been chosen.
